...
export build_trenberth_observables, build_flux_arrow_observables, get_solar_constant,
       plot_trenberth_diagram, save_trenberth_gif, save_flux_timeseries_gif, save_flux_maps_gif
...
using GLMakie, Observables, Dates, SpeedyWeather, TrenberthCallbacks
